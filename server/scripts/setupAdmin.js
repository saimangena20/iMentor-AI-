...
async function setupAdmin(mongoUri) {
    ...
    try {
        ...
        if (!adminUser) {
            ...
            // Only prompt for modification if FORCE_ADMIN_PROMPT is set
            if (process.env.FORCE_ADMIN_PROMPT === 'true') {
                ...
                console.log('\x1b[32m[Admin Setup] Skipping modification (set FORCE_ADMIN_PROMPT=true to enable prompt).\x1b[0m');
            }
        }
